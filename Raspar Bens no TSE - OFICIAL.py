...
ano = int(input ('Qual é o ano da eleição que você quer consultar? Temos 2006, 2008, 2010, 2012, 2014 e 2016.'))
...
cargo_escolhido = input('Agora você precisa escolher o cargo que vamos analisar. As opções dependem do ano de eleição: Ex.: Vereador, Deputado, Prefeito, Vice-prefeito, Deputado Federal, Deputado Estadual e Presidente')
...
if ano == 2016 or 2012 or 2008:
    ...
    filtrado_cidade = filtrado_situacao

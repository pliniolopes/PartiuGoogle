...
with open(f"Bens\\bem_candidato_2016_{estado}.txt", "r") as f:
    content = f.readlines()
...
with open(f"Candidatos\\consulta_cand_2016_{estado}.txt", "r") as f:
    content = f.readlines()
...
cargo_escolhido = input('Qual cargo você quer analisar? Vereador, Deputado, Prefeito ou Vice-prefeito? ')
